...
import { faPaw, faDog, faBone, faCat, faAlignJustify, faPenToSquare, faRightToBracket, faLock } from '@fortawesome/free-solid-svg-icons'
...
const SideNav = ({ user }) => {
    ...
    const authenticatedOptions = (
        <>
            ...
            <MenuItem routerLink={<Link to='bookings' />}> My Bookings </MenuItem>
